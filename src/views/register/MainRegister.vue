    ...
    <div class="flex flex-col w-full pt-10">
        ...
        <div>
            <form @submit.prevent="submitForm" class="space-y-4">
                <div>
                    <label for="nickname" class="block text-sm font-medium text-white">Nombre de usuario</label>
                    ...
                    <template v-if="nickname.length > 0">
                        <p class="text-green-600" v-if="nicknameValid">Nombre Válido</p>
                        <p v-else class="text-red-600">El nombre no es Válido</p>
                    </template>
                    <p v-else-if="faltaNickname" class="text-red-600">El nombre es un campo requerido</p>
                </div>
...
const validateForm = () => {
    faltaEmail.value = email.value.length === undefined;
    faltaPassword.value = password.value.length === undefined;
    faltaPasswordConfirm.value = passwordConfirm.value.length === undefined;
    faltaNickname.value = nickname.value.length === undefined;
