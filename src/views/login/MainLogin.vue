    ...
    <div class="flex flex-col w-full pt-10 md:w-full ">
        ...
        <div>
            ...
            <form @submit.prevent="submitForm" class="space-y-4">
                ...
                <button v-if="pwaEvent" @click="promptInstall" class="bg-white h-12 rounded-lg">Instalar App</button>
...
const email = ref('rendon.luisgerardo@gmail.com');
...
const loginUsuario = async (miembro) => {
    ...
    loginStore('Luis Rendon', 'rendon martinez')
    // let respuesta = {}
    // try {
