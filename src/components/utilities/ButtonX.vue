<template>
    <button @click="onClick" :disabled="isLoading" :class="[{
        'w-full bg-white rounded-lg text-bgPrimary font-semibold text-lg flex justify-center items-center': isWhite,
        'w-full bg-bgPrimary rounded-lg text-white font-semibold text-lg flex justify-center items-center': isBlue,
        ...
        'w-full bg-darkPurple rounded-md text-white font-semibold text-lg flex justify-center items-center': isPurpleDark,
        'w-full bg-lightPurple rounded-md  text-white font-semibold text-lg flex justify-center items-center': isPurpleLight,
...
const isPurpleDark = ref(false);
const isPurpleLight = ref(false);
...
onMounted(() => {
    switch (props.color) {
        ...
        case 'green':
            ...
            break;
        case 'purpleDark':
            isPurpleDark.value = true;
            break;
        case 'purpleLight':
            isPurpleLight.value = true;
            break;
