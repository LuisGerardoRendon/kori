<template>
    <div :class="[{ 'relative': isOpen  }]">
        ...
        <div @click="isOpen = !isOpen" class="w-full bg-bgPrimary p-1 flex flex-row justify-center text-white font-semibold text-center items-center"
        ...
        <div v-show="isOpen" class="absolute  w-full bg-white border-b border-r border-l border-bgPrimary shadow-xl rounded max-h-40 overflow-scroll "
            :class="{ 'pb-3': isOpen }">
