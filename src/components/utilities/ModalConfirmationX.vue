<template>
    <div @click="clickOut" v-if="isVisible"
        ...
        <div class="bg-gray-100 h-fit pb-10 rounded-lg  w-full md:w-2/4 mx-4 z-50">
            <div class="w-full flex flex-row h-12 bg-bgPrimary rounded-t-lg text-white justify-center items-center">
            ...
            <div class="p-3">
                ...
                <div class="flex flex-row w-full mt-3">
                    <div class="w-1/2 px-3">
                        ...
                        :class="[{'bg-bgPrimary' : isImportant},{'bg-red-600' : !isImportant} ] "
                            @click="emitirCancelar">{{ textoCancelar }}</button>
                    </div>
                    <div class="w-1/2 px-3">
                        <button @click="emitirRealizar" class="w-full rounded-lg h-12 text-white font-semibold" :class="[{'bg-red-600' : isImportant},{'bg-bgPrimary' : !isImportant} ] ">{{ textoRealizar }}</button>
                    </div>
