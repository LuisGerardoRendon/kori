<template>
    ...
    <div class="md:w-64 md:h-full">
        ...
        <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar"
            ...
            class="inline-flex bg-bgPrimary   items-center p-2 mt-2 ms-3 text-sm text-white rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
        ...
        <aside :class="{ 'translate-x-0': isSidebarOpen, '-translate-x-full': !isSidebarOpen }"
            ...
            <div class="h-full px-3 py-4 overflow-y-auto  bg-bgPrimary">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="#" @click="goHome"
                            class="flex items-center p-2 md:px-2 md:py-6 text-white text-xl rounded-lg hover:bg-bgPrimaryLight hover:text-textBlueDark group">
